...
const Page = async ({ params }: Props) => {
  ...
  const service: Service | undefined = serviceRaw
    ? { ...serviceRaw, rating: serviceRaw.rating.toString() }
    : undefined;
          ...
          <div className="md:flex-1 px-4">
            ...
            <div className="flex -mx-2 mb-4">
              <div className="w-1/2 px-2">
                <button className="w-full bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700 cursor-pointer">
                  Add to Cart
                </button>
              </div>
              <div className="w-1/2 px-2">
                <button className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600 cursor-pointer">
                  Add to Wishlist
                </button>
              </div>
            </div>
